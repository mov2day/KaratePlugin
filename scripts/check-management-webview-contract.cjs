...
const requirements = [
  ...
  ['disposed sidebar reference cleanup', /if \(this\._view\?\.webview === webview\) this\._view = undefined/],
  ['disposed expanded reference cleanup', /if \(this\._expandedPanel\?\.webview === webview\) this\._expandedPanel = undefined/],
