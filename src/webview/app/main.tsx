...
function App() {
    ...
    useEffect(() => {
        const onMessage = (event: MessageEvent<{ type?: string; data?: Snapshot | CoverageSnapshot; message?: string }>) => {
    ...
    return <main class="management-shell">
        ...
        <section class="workspace">
            ...
            {activeArea === 'quality' && <Quality findings={snapshot.findings || []} coverage={coverage} folderPath={snapshot.folderPath} query={query} />}
