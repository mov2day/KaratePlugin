...
function App() {
    ...
    return <main class="management-shell">
        ...
        <section class="workspace">
            ...
            {activeArea === 'operations' && <Operations bugHunter={bugHunter} />}
